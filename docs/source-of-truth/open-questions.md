...
| Q-NOTION-WORKER-RISKS | Notion dispatcher and GitHub reconciler still have rollout-time operational limits. | See `tools/notion-github-dispatcher/ROLLOUT-RISKS.md` for the current risk register: timeline-based PR discovery, poll latency, partial CI awareness, and conservative handling of closed issues. | DevOps / Architect | Open |
