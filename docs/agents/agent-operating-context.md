...
Node.js 24.16.0 · npm 11.16.0 · pnpm 10.12.4 · git · GitHub CLI · Docker + Compose · Playwright · Vercel CLI · Supabase CLI · Stripe CLI · Notion CLI · Claude Code · GitHub Copilot Pro · ChatGPT Pro · Canva Pro · PostHog · Datadog.

> **Node default is 24.16.0** and the workspace toolchain is **pnpm 10.12.4 + Turborepo**. Cursor and Codex were not detected locally during the 2026-05-31 environment audit; treat them as optional secondary tools, not required local dependencies.
