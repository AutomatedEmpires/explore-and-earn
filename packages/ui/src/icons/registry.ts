...
export const ICON_REGISTRY: Record<IconKey, IconEntry> = {
	...
	"category.mix": { key: "category.mix", streamline: "compass / map", placeholder: "\u{1F9ED}", label: "Mix / Multi-category" },
	...
	"benefit.transport": { key: "benefit.transport", streamline: "bus / car / road", placeholder: "\u{1F690}", label: "Transport provided" },
	...
	"mappin.mix": { key: "mappin.mix", streamline: "map-pin (mix tint)", placeholder: "\u{1F4CD}", label: "Mix pin" },
	"mappin.cluster": { key: "mappin.cluster", streamline: "stacked pins / number badge", placeholder: "\u{1F522}", label: "Clustered pins" },
	// ---- trust ----
	...
	"trust.featured_employer": { key: "trust.featured_employer", streamline: "star", placeholder: "\u{2B50}", label: "Featured Employer" },
	// ---- status ----
	...
	"action.message": { key: "action.message", streamline: "chat / speech-bubble", placeholder: "\u{1F4AC}", label: "Message" },
	"action.filter": { key: "action.filter", streamline: "sliders", placeholder: "\u{1F39B}", label: "Filter" },
	...
	"analytics.source": { key: "analytics.source", streamline: "bars / source", placeholder: "\u{1F4CA}", label: "Source breakdown" },
	// ---- system ----
