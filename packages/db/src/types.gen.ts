...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      ensure_my_seeker_profile: { Args: never; Returns: string }
      get_clerk_user_id: { Args: never; Returns: string }
      get_my_host_benefit_library: { Args: never; Returns: Json }
      ...
      restore_invite_credit: { Args: { p_invite_id: string }; Returns: boolean }
      save_owned_benefit_detail: {
        Args: { p_detail: Json; p_kind: string; p_listing_id: string }
        Returns: {
          benefit_details: Json
      ...
      set_my_housing_library_photo: {
        Args: { p_role: string; p_url: string }
        Returns: {
          benefit_library: Json
          host_profile_id: string
          previous_url: string
